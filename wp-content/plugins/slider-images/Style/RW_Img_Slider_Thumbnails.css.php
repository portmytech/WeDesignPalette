...
{ 
    background: url("<?php echo plugin_dir_url( __DIR__ ).'Images/icon-'. $Rich_Web_Slider_Effect[0]->Rich_Web_Sl_TSL_Arr_Type . '.png'?>") no-repeat center center;
    background-size:100% 100%;
}
.anythingSlider<?php echo $Rich_Web_Slider_Manager[0]->id; ?>-metallic .forward a
{
    background: url("<?php echo plugin_dir_url( __DIR__ ).'Images/icon-'. $Rich_Web_Slider_Effect[0]->Rich_Web_Sl_TSL_Arr_Type .'-'. $Rich_Web_Slider_Effect[0]->Rich_Web_Sl_TSL_Arr_Type .'.png'?>") no-repeat center center;
    background-size:100% 100%;
}
